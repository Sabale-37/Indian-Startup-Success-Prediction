...
dataset = pd.read_csv(r'C:\Users\Asus\Desktop\git hackathon\Indian-Startup-Success-Prediction\businessPrediction\startup_sentiment.tsv', delimiter='\t', quoting=3)
